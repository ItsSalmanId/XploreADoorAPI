...
,N'@First_Name VARCHAR(50),@Last_Name VARCHAR(50),@Middle_Name VARCHAR(50),@SSN VARCHAR(9),@Gender VARCHAR(15),@DOB VARCHAR(50),@CHART_ID VARCHAR(100),@Patient_Alias BIT,@PRACTICE_CODE BIGINT,@PRACTICE_ORGANIZATION_ID BIGINT        
