...
SELECT PROVIDER, REGION,PT_OT_SLP,PS.SURVEY_ID FROM FOX_TBL_PATIENT_SURVEY PS WITH (NOLOCK)  
...
WHERE PATIENT_ACCOUNT_NUMBER = @PATIENT_ACCOUNT AND ISNULL(PS.DELETED, 0) = 0    
