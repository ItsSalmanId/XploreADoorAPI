IF (OBJECT_ID('FOX_PROC_GET_DISCHARGE_SURVEY_LAST_14_DAYS_AVERAGE') IS NOT NULL ) DROP PROCEDURE FOX_PROC_GET_DISCHARGE_SURVEY_LAST_14_DAYS_AVERAGE 
GO            
-- =============================================            
...
CREATE PROCEDURE FOX_PROC_GET_DISCHARGE_SURVEY_LAST_14_DAYS_AVERAGE                                                                   
 ...
 BEGIN             
    ...
    FROM FOX_TBL_PATIENT_SURVEY AS PS           
    LEFT JOIN FOX_TBL_APPLICATION_USER AS AU ON AU.USER_NAME = PS.MODIFIED_BY          
    WHERE                     
