...
BEGIN        
 ...
 SET @EXISTING_SURVEY_AUTOMATION_LOG_ID = ( Select TOP 1 SURVEY_AUTOMATION_LOG_ID From FOX_TBL_SURVEY_AUTOMATION_SERVICE_LOG  where PATIENT_ACCOUNT = @PATIENT_ACCOUNT AND PRACTICE_CODE = @PRACTICE_CODE AND DELETED = 0)  
