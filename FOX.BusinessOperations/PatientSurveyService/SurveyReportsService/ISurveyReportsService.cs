...
namespace FOX.BusinessOperations.PatientSurveyService.SurveyReportsService
{
    ...
    {
        List<PatientSurvey> GetPSRDetailedReport(PatientSurveySearchRequest patientSurveySearchRequest, UserProfile profile, PatientSurveyNotAnswered objNotAnswered);
