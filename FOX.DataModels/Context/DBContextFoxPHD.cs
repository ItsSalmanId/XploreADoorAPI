...
namespace FOX.DataModels.Context
{
    public class DBContextFoxPHD : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PhdFaqsDetail>().Property(t => t.FAQS_ID).HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
        }
        ...
        public virtual DbSet<PhdFaqsDetail> PHDFAQsDetail { get; set; }
    }
}
