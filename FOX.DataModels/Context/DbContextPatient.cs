...
namespace FOX.DataModels.Context
{
    public class DbContextPatient : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<WebehrTblPatientCareTeams>().Property(t => t.PatientCareTeamID).HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
            ...
            modelBuilder.Entity<AcquisitionPatient>().Property(t => t.PATIENT_ACCOUNT).HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
        }
        ...
        public virtual DbSet<WebehrTblPatientCareTeams> WebehrTblPatientCareTeams { get; set; }
        ...
        public virtual DbSet<AcquisitionPatient> AcquisitionPatient { get; set; }
    }
}