...
namespace FOX.DataModels.Context
{
    public class DbContextSettings : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FOX_TBL_OTP_ENABLE_DATE>().Property(t => t.FOX_TBL_OTP_ENABLE_ID).HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
